/**
 * 统一矢量图标库（Lucide 风格：24 viewBox / stroke 2 / 圆角线帽）
 * 用法：icon('play', 20, true) 返回 svg 字符串
 */
const I = {
  ...
  muted: '<polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" fill="currentColor" stroke="none"/><line x1="23" y1="9" x2="17" y2="15"/><line x1="17" y1="9" x2="23" y2="15"/>',
  ...
  pip: '<rect x="2" y="4" width="20" height="14" rx="2"/><rect x="12" y="10" width="8" height="6" rx="1" fill="currentColor" stroke="none" opacity=".9"/>',
  ...
  minimize: '<line x1="5" x2="19" y1="12" y2="12"/>',
  ...
  subtitle: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><line x1="7" x2="13" y1="9" y2="9"/><line x1="15" x2="17" y1="9" y2="9"/><line x1="7" x2="10" y1="13" y2="13"/><line x1="12" x2="17" y1="13" y2="13"/>',
  ...
  robot: '<rect x="4" y="8" width="16" height="12" rx="2"/><path d="M12 8V4"/><circle cx="12" cy="3" r="1" fill="currentColor" stroke="none"/><circle cx="9" cy="13" r="1" fill="currentColor" stroke="none"/><circle cx="15" cy="13" r="1" fill="currentColor" stroke="none"/><path d="M9 17h6"/>',
  library: '<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/><path d="M2 11h20"/>',
